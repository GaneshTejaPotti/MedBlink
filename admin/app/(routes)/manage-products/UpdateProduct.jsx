...
import FilterDropdown from "@/app/_ui_components/FilterDropdown";
...
const UpdateProduct = () => {
  ...
  const handleCheck = () => {
    // Send checkDetail to backend and request back Product detail with required batchId & productId....
    ...
    setUpdateProductDetail(mockProductData);
  ...
  return (
    <div className="m-7 flex flex-col gap-5">
      <div className="flex items-center justify-start border-2 p-5 w-full gap-5 rounded-lg">
        ...
        <div className={classes.group}>
          <input
            ...
            name="batchId"
            className={`${classes.inputText} w-[400px]`}
            value={checkDetail.batchId}
            onChange={handleCheckChange}
          />
          <span className={classes.highlight}></span>
          <span className={classes.bar}></span>
          <label className={classes.labelInput}>BatchId</label>
        </div>
      ...
      <div className="flex flex-col gap-y-5">
        {isProductAvailable && (
          <div className="flex flex-col gap-y-5 p-5 border-2 rounded-lg">
            <div>
              <h2 className="font-bold text-lg italic">
                Product Details of BatchId:
              </h2>
            </div>
            <div className="flex gap-5">
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  value={updateProductDetail.productId}
                  name="productId"
              ...
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="productName"
                  onChange={handleChange}
                  value={updateProductDetail.productName}
              ...
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  onChange={handleChange}
                  value={updateProductDetail.productDescription}
            ...
            <div className="flex gap-10 items-center justify-start">
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="productMrp"
                  onChange={handleChange}
                  value={updateProductDetail.productMrp}
              ...
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="costPrice"
                  onChange={handleChange}
                  value={updateProductDetail.costPrice}
                  className="border-gray-300 input px-[10px] py-[11px] text-md bg-white border-2 rounded-[5px] w-[300px] focus:outline-none placeholder:text-black/25 focus:border-red-500"
                />
              </div>
              ...
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="retailerPrice"
                  onChange={handleChange}
                  value={updateProductDetail.retailerPrice}
                  className="border-gray-300 input px-[10px] py-[11px] text-md bg-white border-2 rounded-[5px] w-[300px] focus:outline-none placeholder:text-black/25 focus:border-red-500"
                />
              </div>
              ...
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="userPrice"
                  onChange={handleChange}
                  value={updateProductDetail.userPrice}
                  className="border-gray-300 input px-[10px] py-[11px] text-md bg-white border-2 rounded-[5px] w-[300px] focus:outline-none placeholder:text-black/25 focus:border-red-500"
                />
              </div>
            </div>
            ...
            <div className="flex gap-10 items-center justify-start">
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  id="discount"
                  type="text"
                  placeholder="Eg: 2%, 5%, etc..."
                  name="discount"
                  onChange={handleChange}
                  value={updateProductDetail.discount}
                  className="border-gray-300 input px-[10px] py-[11px] text-md bg-white border-2 rounded-[5px] w-[300px] focus:outline-none placeholder:text-black/25 focus:border-red-500"
                />
              </div>
              ...
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="pack"
                  onChange={handleChange}
                  value={updateProductDetail.pack}
                  className="border-gray-300 input px-[10px] py-[11px] text-md bg-white border-2 rounded-[5px] w-[300px] focus:outline-none placeholder:text-black/25 focus:border-red-500"
                />
              </div>
              ...
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="batch"
                  onChange={handleChange}
                  value={updateProductDetail.batch}
                  className="border-gray-300 input px-[10px] py-[11px] text-md bg-white border-2 rounded-[5px] w-[300px] focus:outline-none placeholder:text-black/25 focus:border-red-500"
                />
              </div>
            </div>
            ...
            <div className="flex gap-10 items-baseline justify-start">
              <div className="input flex flex-col w-fit static">
                ...
                <input
                  ...
                  name="expiryDate"
                  onChange={handleChange}
                  value={updateProductDetail.expiryDate}
                  className="border-gray-300 input px-[10px] py-[11px] text-md bg-white border-2 rounded-[5px] w-[300px] focus:outline-none placeholder:text-black/25 focus:border-red-500"
                />
              </div>
